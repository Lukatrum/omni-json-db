...
2. Fork `the repository <https://github.com/lukatrum/omni-json-db/>`_ on Github,
...
Philosophy of **omni-json-db** 
*******************************

**omni-json-db**  aims to be simple and fun to use. Therefore two key values are simplicity
...
In general the **omni-json-db**  source should always follow `PEP 8 <http://legacy.python.org/dev/peps/pep-0008/>`_.
...
**omni-json-db**  follows the `SemVer versioning guidelines <http://semver.org/>`_.
