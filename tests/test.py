...
class TestJDb(unittest.TestCase):
    def setUp(self):
        ...
        self.jdb_configs = [
            ...
            {'KEY_file':'db/test_x7bz.jdb', 'api_ver':1, 'data_type':'J+S', 'zip_type':'bz', 'max_file_size' :     None, 'reserved_rate': 0.0, 'cache_limit':-1, 'min_value_size':128, 'index_size':128, 'key_limit':'--'},
